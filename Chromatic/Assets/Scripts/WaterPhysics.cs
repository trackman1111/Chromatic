...
public class WaterPhysics : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        x_force = x_force * 0.025f;
        y_force = y_force * 0.025f;
    }
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        if (collision.attachedRigidbody == true)
        {
            ...
            collision.attachedRigidbody.transform.Translate(new Vector2(x_force, 0));
            collision.attachedRigidbody.AddForce(new Vector2(0, y_force), ForceMode2D.Impulse);
